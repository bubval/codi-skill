...
DIAGRAMS = [
    ...
    DiagramSkill(
        ...
        title="CoDi Class",
        diagram_type="class",
        purpose="UML class, interface, enum, datatype, and package diagrams, including scanner-generated code structure.",
        choose_when=[
        ...
        node_types=["class", "interface", "enum", "datatype", "package"],
        edge_types=STRUCTURAL_RELATIONSHIPS,
        diagram_props=LAYOUT_PROPS,
        node_props=[
            *COMMON_NODE_PROPS,
            ("members", "list[string]", "Class/interface/enum/datatype members."),
